...
<!-- Mirrored from altair_html.tzdthemes.com/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 May 2019 11:50:54 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="md-card-content large-padding" id="login_form">
                ...
                <form action="verifica_login.php" method="post">
                    <div class="uk-form-row">
                        ...
                        <input class="md-input" type="text" placeholder="Login" id="login_username" name="c_nickname" />
                    </div>
                    <div class="uk-form-row">
                        
                        <input class="md-input" type="password" placeholder="Senha" id="login_password" name="c_senha" />
                    </div>
                    <div class="uk-margin-medium-top">
                        <input type="submit" name="botao" class="md-btn md-btn-primary md-btn-block md-btn-large" value="Entrar">
...
<!-- Mirrored from altair_html.tzdthemes.com/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 May 2019 11:50:56 GMT -->
</html>