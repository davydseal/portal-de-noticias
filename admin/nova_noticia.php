...
<div id="page_content">
 <div id="page_content_inner">
            ...
            <div class="md-card">
                <div class="md-card-content">
                    <h3 class="heading_a">Cadastro de notícias</h3>
                    <div class="uk-grid" data-uk-grid-margin>

                        <div class="uk-width-medium-1-2">
                            <form name="f" action="nova_noticia2.php" method="post" enctype="multipart/form-data">
                            <div class="uk-form-row">
                                <label>Titulo</label>
                                <input type="text" name="c_titulo" class="md-input" />
                            </div>

<div class="uk-form-row">
                                <label>Notícia</label>
                                <textarea cols="30" name="c_noticia" rows="4" class="md-input"></textarea>
