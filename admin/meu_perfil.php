...
<!-- Mirrored from altair_html.tzdthemes.com/page_user_profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 May 2019 11:49:05 GMT -->
<head>
    <meta charset="UTF-8">
                                            ...
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <span class="md-user-letters md-bg-cyan">ep</span>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Dolore ex.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Exercitationem quas aliquid iure illum est et at omnis ipsa architecto non.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Quos hic corrupti.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Labore id consectetur tenetur labore ipsam magni voluptas.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <span class="md-user-letters md-bg-light-green">yi</span>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Aut impedit illum.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Aut laborum laudantium adipisci incidunt sequi quisquam soluta quam nam.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Voluptate fugiat.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Rerum minima repellendus in et libero maiores.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Est maiores.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Ad consectetur possimus provident delectus ratione alias aut dolorem.</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <li>
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Ea veritatis quo.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Impedit natus consequatur ut nesciunt doloremque consequatur.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Et tenetur.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Facere provident aut iusto sit quam fugit quasi.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Voluptatem alias.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Ut necessitatibus sed neque numquam est ipsam recusandae.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Expedita exercitationem iste.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Dicta aperiam quisquam similique aut autem minus qui.</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </li>
...
?>
                                ...
                                <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?php print($vetor_foto['nickname']); ?></span></h2>
                                <ul class="user_stats">
                                    <li>
                            ...
                            <a class="md-fab md-fab-small md-fab-accent hidden-print" href="editar_perfil.php">
...
<?php
             ...
             $vetor2 = mysqli_fetch_array($resultado2);
                            ...
                            ?>
                                                    <div class="md-list-content">
                                                      <span class="md-list-heading"><?php print($vetor2['email']); ?></span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">(705)397-8233x362</span>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php print($vetor2['nome']); ?></span>
                                                        <span class="uk-text-small uk-text-muted">Nome</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php print($vetor2['sobrenome']); ?></span>
                                                        <span class="uk-text-small uk-text-muted">Sobrenome</span>
                                                    </div>
                                                </li>
                                                 <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php print($vetor2['dn_dia']); ?>/<?php print($vetor2['dn_mes']); ?>/<?php print($vetor2['dn_ano']); ?></span>
                                                        <span class="uk-text-small uk-text-muted">Data de nascimento</span>
                                                    </div>
                                                </li>
                                                 <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><?php print($vetor2['sexo']); ?></span>
                                                        <span class="uk-text-small uk-text-muted">Gênero</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
...
<!-- Mirrored from altair_html.tzdthemes.com/page_user_profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 May 2019 11:50:50 GMT -->
</html>