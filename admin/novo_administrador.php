    ...
    <aside id="sidebar_main">
        ...
        <div class="sidebar_main_header">
            <div class="sidebar_logo">
                ...
                <a href="admin.html" class="sSidebar_show sidebar_logo_small">
        ...
        <div class="menu_section">
            <ul>
                ...
                <li title="Forms">
                    ...
                    <ul>
                        <li class="act_item"><a href="novo_administrador.php">Cadastro de administrador</a></li>
...
<div id="page_content">
 <div id="page_content_inner">
            ...
            <div class="md-card">
                <div class="md-card-content">
                    <h3 class="heading_a">Cadastro de administrador</h3>
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <div class="uk-width-medium-1-2">
                            ...
                            <div class="uk-form-row">
                                <label>Nome</label>
                                <input type="text" name="c_nome" class="md-input" />
                            </div>
                            <div class="uk-form-row">
                                <label>Sobrenome</label>
                                <input type="text" name="c_sobrenome" class="md-input" />
                            </div>
                            <div class="uk-form-row">
                                <label>Data de nascimento</label>
                                <select id="select_demo_2" name="c_dia" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select with tooltip">
 ...
 <option value="01">01</option>
      ...
      <option value="31">31</option>
                            ...
                            <select name="c_mes" id="select_demo_2" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select with tooltip">
                                <option  value="" disabled selected hidden>Select...</option>
      ...
      <option value="12">Dezembro</option>
                            ...
                            <select name="c_ano" id="select_demo_2" class="md-input" data-uk-tooltip="{pos:'top'}" title="Select with tooltip">
                                <option value="" disabled selected hidden>Select...</option>
      ...
      <option value="1930">1930</option>
                             ...
                             <div class="uk-form-row">
                                <label>Email</label>
                                <input type="text" name="c_email" class="md-input" />
                            </div>

                            <div class="uk-form-row">
                                <label>Endereço</label>
                                <input type="text" name="c_endereco" class="md-input" />
                            </div>
  <div class="uk-form-row">
                             <span class="icheck-inline">
                                        <input type="radio" name="c_sexo" value="M" id="radio_demo_inline_1" data-md-icheck />
                                        <label for="radio_demo_inline_1" class="inline-label">Masculino</label>
                                    </span>
                                    <span class="icheck-inline">
                                        <input type="radio" name="c_sexo" value="F" id="radio_demo_inline_2" data-md-icheck />
                                        <label for="radio_demo_inline_2" class="inline-label">
                                        Feminino</label>
                                    </span>
</div>
                            ...
                            <div class="uk-form-row">
                                <label>Login</label>
                                <input type="text"name="c_nickname"  class="md-input" />
                            </div>

                            <div class="uk-form-row">
                                <label>Senha</label>
                                <input type="password" name="c_senha" class="md-input" />
                            </div>

                             <div class="uk-form-row">
                                <label>Confirmar senha</label>
                                <input type="password" name="c_senha2" class="md-input" />
                            </div>
