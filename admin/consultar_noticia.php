...
<!-- Mirrored from altair_html.tzdthemes.com/ecommerce_products_list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 May 2019 11:52:03 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="disable_transitions sidebar_main_open sidebar_main_swipe">
                                            ...
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <span class="md-user-letters md-bg-cyan">xy</span>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Consequatur asperiores sunt.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Earum eligendi quia aut dolorem blanditiis perspiciatis.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Sunt non mollitia.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Modi suscipit quia hic atque voluptas.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <span class="md-user-letters md-bg-light-green">ie</span>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Consequatur voluptates velit.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Molestiae et earum quia dolorem et rerum.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Et cum.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Non sint aut ipsam eligendi consequatur dolores.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="page_mailbox.html">Saepe sint.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Et quod culpa in earum recusandae ad itaque.</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <li>
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Quas quas.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Sunt quasi ea sunt voluptates quibusdam corrupti consequatur.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Dolores quia.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Dolorum animi similique accusantium eligendi.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Dolores labore porro.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Non est accusantium saepe quia earum dolor.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Occaecati exercitationem.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Enim accusamus libero nihil fugiat distinctio.</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </li>
                        ...
                        <li data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                            ...
                            <div class="uk-dropdown uk-dropdown-small">
                                <ul class="uk-nav js-uk-prevent">
                                    <li><a href="page_user_profile.html">Meu perfil</a></li>
    ...
    <aside id="sidebar_main">
        ...
        <div class="sidebar_main_header">
            <div class="sidebar_logo">
                ...
                <a href="admin.phpl" class="sSidebar_show sidebar_logo_small">
            ...
            <ul>
                ...
                <li title="E-commerce">
                    ...
                    <ul>
                        ...
                        <li class="act_item"><a href="ecommerce_products_list.html">Products List</a></li>
    ...
    <?php
            ...
            ?>
                                        ...
                                        <tr>
                                            <td><img class="img_thumb" src="../img/<?php print($variavel['img']); ?>" alt=""></td>
                                            <td class="uk-text-large uk-text-nowrap"><a href="ecommerce_product_details.html"><?php print($variavel['titulo']); ?></a></td>
                                            <td class="uk-text-nowrap">$ 474.00</td>
                                            <td>44</td>
                                            ...
                                            <td class="uk-text-nowrap">
                                                <!--
                                                -->
                                                <form name="slipknot" action="excluir.php" method="post">
<input type="hidden" name="codigo" value="<?php print($variavel['codigo']); ?>">
